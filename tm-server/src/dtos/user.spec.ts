  ...
  billingGroups: [
    {
      ...
      timeline: [
        {
          begin: new Date(0),
          end: new Date(2023, 2, 23, 23, 59, 59, 999),
          jobTitle: 'Ingénieur',
          rate: 150,
        },
        { begin: new Date(2023, 2, 24), jobTitle: 'Ingénieur', rate: 175 },
      ...
      errors: [
        {
          property: 'username',
          constraints: {
            isString: 'username doit être du texte',
            isNotEmpty: 'username ne doit pas être vide',
          },
        },
        {
          property: 'firstName',
          constraints: {
            isString: 'firstName doit être du texte',
            isNotEmpty: 'firstName ne doit pas être vide',
          },
        },
        {
          property: 'lastName',
          constraints: {
            isString: 'lastName doit être du texte',
            isNotEmpty: 'lastName ne doit pas être vide',
          },
        },
        {
          property: 'role',
          constraints: {
            isEnum: 'role doit être une de ces valeurs: 1, 2, 4, 8',
          },
        },
        {
          property: 'email',
          constraints: {
            isEmail: 'email doit être adresse courriel',
            isString: 'email doit être du texte',
          },
        },
        {
          property: 'password',
          constraints: {
            isString: 'password doit être du texte',
            isNotEmpty: 'password ne doit pas être vide',
          },
        },
        {
          property: 'billingGroups',
          constraints: {
            arrayMaxSize: 'Il doit y avoir 2 groupes de facturations',
            arrayMinSize: 'Il doit y avoir 2 groupes de facturations',
            arrayUnique:
              'Il doit y avoir une liste de taux pour chaque type de facturation',
            isArray: 'billingGroups doit être une liste',
          },
        },
        {
          property: 'isActive',
        ...
        billingGroups: [
          {
            projectType: ProjectType.PRIVE,
            timeline: [
              { begin: new Date(0), jobTitle: 'Ingénieur', rate: 150 },
            ],
          },
        ],
      }),
        ...
        billingGroups: [
          {
            projectType: ProjectType.PRIVE,
            timeline: [
              { begin: new Date(1999, 0, 1), jobTitle: 'Ingénieur', rate: 150 },
            ],
          },
          {
            projectType: ProjectType.PUBLIC,
              ...
              children: [
                {
                  ...
                  constraints: {
                    timelineBounds:
                      'Le premier intervale doit commencer le 1er Janvier 1970 et le dernier intervale doit être sans fin',
                  },
                },
              ],
            },
              ...
              children: [
                {
                  ...
                  constraints: {
                    timelineCompleteness:
                      'Les intervales doivent se suivre sans espaces et sans chevauchements',
                  },
                },
              ],
            },
              ...
              children: [
                {
                  ...
                  constraints: {
                    isEnum:
                      'projectType doit être une de ces valeurs: Privé, Public',
                  },
                },
              ],
            },
